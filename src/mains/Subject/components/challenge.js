		...
		return(			
			<div className="col-xs-12 col-sm-4 paper">
				<Paper className="preferencepaper">
					...
					<div style={{background: 'rgba(0,0,0,0.1)', width: "100%", margin: 'auto', height: 20}}>
						<div style={{width: width+'%', background: 'linear-gradient(to right, rgb(33, 150, 243), rgb(88, 179, 252)', height: 20}}>
						</div>
					</div>
